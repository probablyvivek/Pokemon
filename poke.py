...
df = pd.read_csv("/Users/vivektiwari/Code and Viz/Python/Pokemon/pokemon_data.csv")
df.head()

#use the pokemon_images.py file to get the images for the pokemon
#import pokemon_images this will download almost 900 images. 
...
#st.set_page_config(page_title='Pokemon Stats App', page_icon='https://bit.ly/3gqQZQe')

#Home Button Function
def home():
    st.sidebar.info('Welcome to the Pokemon Stats App')
    from PIL import Image
    image = os.path.join('/Users/vivektiwari/Code and Viz/Python/Pokemon/Images', 'head.png')
    st.image(image,use_column_width=True)    
    image2 = os.path.join('/Users/vivektiwari/Code and Viz/Python/Pokemon/Images', 'pokemon.jpeg')
